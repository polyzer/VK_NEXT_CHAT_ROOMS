...
*/
_VisualKeeper.prototype.setTargetMeshByCaseMeshIndex = function (json_params)
{
	if(json_params instanceof Object)
	{
		this.TargetMesh = window.MeshesBase.getMeshCopyByIndex(json_params.case_mesh_index);
		this.setSendedCaseViewParameters(json_params);
	}
};
