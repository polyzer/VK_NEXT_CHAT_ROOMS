...
/*
				...
				$stmt->execute();
*/
			$mysqli->query("INSERT INTO `users` (`vk_id`, `capabilities_id`, `status_id`, `date_time`) VALUES ('".$datas["vk_id"]."', '0', '0', '".$datas["date_time"]."');");				
				$result_arr["server_answer"] = 1;
			}			
